...
// in sax_buddy/test/features/auth/services/auth_service_test.dart.
...
import 'package:sax_buddy/services/logger_service.dart' as _i7;
...
class MockLoggerService extends _i1.Mock implements _i7.LoggerService {
  ...
  @override
  _i7.LogLevel get currentLevel =>
      (super.noSuchMethod(
            Invocation.getter(#currentLevel),
            returnValue: _i7.LogLevel.trace,
          )
          as _i7.LogLevel);
